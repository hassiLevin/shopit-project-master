...
export const ORDER_DELIVERED_REQUEST = 'ORDER_DELIVER_REQUEST'
export const ORDER_DELIVERED_SUCCESS = 'ORDER_DELIVER_SUCCESS'
export const ORDER_DELIVERED_FAIL = 'ORDER_DELIVER_FAIL'
export const ORDER_DELIVERED_RESET = 'ORDER_DELIVER_RESET'
